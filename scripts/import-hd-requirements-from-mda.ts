...
const AREA_URL = "https://mda.wiki.br/Habilidades_Dom%C3%A9sticas";
...
async function main() {
  console.log("Importando requisitos de HD...");
...
main()
  .catch((error) => {
    console.error("Erro ao importar requisitos de HD:", error);
    process.exit(1);
  })
  .finally(async () => {
