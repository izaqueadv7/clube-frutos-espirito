...
const AREA_SOURCES: AreaSource[] = [
  {
    ...
    prefix: "HM",
    url: "https://mda.wiki.br/Artes_e_habilidades_manuais"
  },
  {
    area: "Atividades agrícolas",
    prefix: "AA",
    url: "https://mda.wiki.br/Atividades_agr%C3%ADcolas"
  },
  {
    area: "Atividades profissionais",
    prefix: "AP",
    url: "https://mda.wiki.br/Atividades_profissionais"
  },
  {
    area: "Atividades recreativas",
    prefix: "AR",
    url: "https://mda.wiki.br/Atividades_Recreativas"
  },
  {
    area: "Ciência e saúde",
    prefix: "CS",
    url: "https://mda.wiki.br/Ci%C3%AAncia_e_sa%C3%BAde"
  },
  {
    area: "Estudo da natureza",
    prefix: "EN",
    url: "https://mda.wiki.br/Estudos_da_Natureza"
  },
  {
    area: "Habilidades domésticas",
    prefix: "HD",
    url: "https://mda.wiki.br/Habilidades_dom%C3%A9sticas"
  },
  {
    area: "Mestrados",
    prefix: "ME",
    url: "https://mda.wiki.br/Mestrados"
  }
];
...
function parseSpecialtiesFromHtml(html: string, prefix: string) {
  ...
  const regex = new RegExp(
    `${prefix}[-\\s]?(\\d{3})\\s*([\\s\\S]*?)(?=${prefix}[-\\s]?\\d{3}|Páginas nesta Categoria|Categorias|Menções à esta página|Páginas Relacionadas|Conteúdo retirado do site|$)`,
    "gi"
  );
  ...
  for (const match of compact.matchAll(regex)) {
    ...
    // se vier colado com "Especialidade de ..."
    name = name
...
async function main() {
  ...
  console.log("Importação do catálogo concluída.");
}
