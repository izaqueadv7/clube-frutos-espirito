...
export default async function SpecialtiesPage() {
  ...
  const assignments = session.user.role === "LEADER"
  ...
  return (
    <div className="space-y-4">
      <Card className="p-5">
        <h1 className="section-title">Modulo de Especialidades</h1>
        <p className="mt-2 text-sm text-slate-600">
          Visualize o progresso por status: pendente, em andamento e concluida.
        </p>
      </Card>
