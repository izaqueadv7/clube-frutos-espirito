...
export function MobileBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-[#d9cfb8] bg-[#f7f1e3]/95 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/95 lg:hidden">
            ...
            <Link
              ...
              className={[
                ...
                active
                  ...
                  : "text-[#8b5a3c] hover:bg-[#efe5cf] dark:text-slate-300 dark:hover:bg-zinc-900"
              ].join(" ")}
            >
