    ...
    <div className="grid gap-4 xl:grid-cols-[320px_1fr]">
          ...
          {filteredPathfinders.map((item) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-sm text-slate-600 dark:text-slate-800">{item.email}</p>
              </button>
            );
          })}
        </div>
      ...
      <div className="space-y-4">
        <Card className="p-5">
          ...
          {messageClass ? (
            <p className="mt-3 rounded-lg bg-red-50 px-3 py-2 text-sm text-slate-700 dark:text-slate-800">
              {messageClass}
            </p>
          ) : null}
            ...
            {specialties.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <p className="font-semibold">{item.name}</p>
                    <p className="text-sm text-slate-600 dark:text-slate-800">{item.category}</p>
                  </div>
                </label>
              );
            })}
